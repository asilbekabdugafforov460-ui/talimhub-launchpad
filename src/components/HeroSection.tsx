...
export function HeroSection() {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Modern Education" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        delay: 0.2
          ...
          delay: 0.4
            ...
            <span className="text-gradient-primary">Ta'limHub</span>
            <br />
          ...
          delay: 0.8
            ...
            scale: 0.98
              ...
              <Button onClick={handleJoinProject} className="btn-hero-primary group" size="lg">
                {t('hero.cta1')}
            ...
            scale: 0.98
              ...
              <Button onClick={handleInvestorClick} variant="outline" className="btn-hero-secondary group" size="lg">
          ...
          delay: 1
            ...
            {[{
            number: "50K+",
            label: "Kutilayotgan foydalanuvchilar"
          }, {
            number: "100+",
            label: "Hamkor o'quv markazlar"
          }, {
            number: "AI",
            label: "Dublyaj texnologiyasi"
          }, {
            number: "24/7",
            label: "Texnik yordam"
