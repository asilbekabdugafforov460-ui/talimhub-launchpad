...
import { Mic, Search, Trophy, BarChart3, Play, Pause, Volume2, Languages } from 'lucide-react';
...
export function FeaturesSection() {
  ...
  return <section id="features" className="py-20 bg-muted/20">
              ...
              <div className="relative">
                <div className="bg-background rounded-2xl shadow-xl border border-border p-6">
                  <div className="aspect-video bg-gradient-to-br from-primary/20 to-secondary/20 rounded-xl flex items-center justify-center relative overflow-hidden">
                    ...
                    ease: "easeInOut"
                  }} className="w-16 h-16 bg-primary rounded-full flex items-center justify-center cursor-pointer" onClick={() => setIsVideoPlaying(!isVideoPlaying)}>
                      {isVideoPlaying ? <Pause className="h-8 w-8 text-white" /> : <Play className="h-8 w-8 text-white ml-1" />}
                    </motion.div>
